...
df_bias = pd.read_csv(r'path\to\your\data\Desktop\encent\Overall-Source-Ratings-October-2019.csv', sep=',')
...
with open(r'path\to\your\data\Desktop\encent\json\rss_records.json', 'w') as json_file:
    json.dump(json_rss, json_file)

df_rss.to_json(r'path\to\your\data\Desktop\encent\json\rss.json')
